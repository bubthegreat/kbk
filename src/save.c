...
/* kills and killed scores */
	...
	if (paf->name == NULL) paf->name = skill_table[paf->type].name;
...
void fread_char( CHAR_DATA *ch, FILE *fp )
{
	...
	case 'I':
		...
		if (!str_cmp(word,"IsCloaked")) {
			ch->cloaked = fread_number(fp); fMatch = TRUE; break;
		}
	    ...
	    if (!str_cmp( word, "IMMUNE") && ch->version >= 12)
	    {
		 ...
		 for (immLooper = 1; immLooper <= 24; immLooper++)
		 {
			...
			{
				if (immLooper == 1) SET_BIT(ch->imm_flags,IMM_SUMMON);
				else if (immLooper == 2) SET_BIT(ch->imm_flags,IMM_CHARM);
				else if (immLooper == 3) SET_BIT(ch->imm_flags,IMM_MAGIC);
				else if (immLooper == 4) SET_BIT(ch->imm_flags,IMM_WEAPON);
				else if (immLooper == 5) SET_BIT(ch->imm_flags,IMM_BASH);
				else if (immLooper == 6) SET_BIT(ch->imm_flags,IMM_PIERCE);
				else if (immLooper == 7) SET_BIT(ch->imm_flags,IMM_SLASH);
				else if (immLooper == 8) SET_BIT(ch->imm_flags,IMM_FIRE);
				else if (immLooper == 9) SET_BIT(ch->imm_flags,IMM_COLD);
				else if (immLooper == 10) SET_BIT(ch->imm_flags,IMM_LIGHTNING);
				else if (immLooper == 11) SET_BIT(ch->imm_flags,IMM_ACID);
				else if (immLooper == 12) SET_BIT(ch->imm_flags,IMM_POISON);
				else if (immLooper == 13) SET_BIT(ch->imm_flags,IMM_NEGATIVE);
				else if (immLooper == 14) SET_BIT(ch->imm_flags,IMM_HOLY);
				else if (immLooper == 15) SET_BIT(ch->imm_flags,IMM_ENERGY);
				else if (immLooper == 16) SET_BIT(ch->imm_flags,IMM_MENTAL);
				else if (immLooper == 17) SET_BIT(ch->imm_flags,IMM_DISEASE);
				else if (immLooper == 18) SET_BIT(ch->imm_flags,IMM_DROWNING);
				else if (immLooper == 19) SET_BIT(ch->imm_flags,IMM_LIGHT);
				else if (immLooper == 20) SET_BIT(ch->imm_flags,IMM_SOUND);
				else if (immLooper == 21) SET_BIT(ch->imm_flags,IMM_WOOD);
				else if (immLooper == 22) SET_BIT(ch->imm_flags,IMM_SILVER);
				else if (immLooper == 23) SET_BIT(ch->imm_flags,IMM_IRON);
				else if (immLooper == 24) SET_BIT(ch->imm_flags,IMM_SLEEP);
			}
		}
		fMatch = TRUE;
	   }
	...
	case 'R':
	    ...
	    if (!str_cmp( word, "RESIST") && ch->version >= 12)
	    {
		 ...
		 for (resLooper = 1; resLooper <= 23; resLooper++)
		 {
			if ( fread_number(fp) == 1 )
			{
				if (resLooper == 1) SET_BIT(ch->res_flags,RES_SUMMON);
				else if (resLooper == 2) SET_BIT(ch->res_flags,RES_CHARM);
				else if (resLooper == 3) SET_BIT(ch->res_flags,RES_MAGIC);
				else if (resLooper == 4) SET_BIT(ch->res_flags,RES_WEAPON);
				else if (resLooper == 5) SET_BIT(ch->res_flags,RES_BASH);
				else if (resLooper == 6) SET_BIT(ch->res_flags,RES_PIERCE);
				else if (resLooper == 7) SET_BIT(ch->res_flags,RES_SLASH);
				else if (resLooper == 8) SET_BIT(ch->res_flags,RES_FIRE);
				else if (resLooper == 9) SET_BIT(ch->res_flags,RES_COLD);
				else if (resLooper == 10) SET_BIT(ch->res_flags,RES_LIGHTNING);
				else if (resLooper == 11) SET_BIT(ch->res_flags,RES_ACID);
				else if (resLooper == 12) SET_BIT(ch->res_flags,RES_POISON);
				else if (resLooper == 13) SET_BIT(ch->res_flags,RES_NEGATIVE);
				else if (resLooper == 14) SET_BIT(ch->res_flags,RES_HOLY);
				else if (resLooper == 15) SET_BIT(ch->res_flags,RES_ENERGY);
				else if (resLooper == 16) SET_BIT(ch->res_flags,RES_MENTAL);
				else if (resLooper == 17) SET_BIT(ch->res_flags,RES_DISEASE);
				else if (resLooper == 18) SET_BIT(ch->res_flags,RES_DROWNING);
				else if (resLooper == 19) SET_BIT(ch->res_flags,RES_LIGHT);
				else if (resLooper == 20) SET_BIT(ch->res_flags,RES_SOUND);
				else if (resLooper == 21) SET_BIT(ch->res_flags,RES_WOOD);
				else if (resLooper == 22) SET_BIT(ch->res_flags,RES_SILVER);
				else if (resLooper == 23) SET_BIT(ch->res_flags,RES_IRON);
			}
		}
		fMatch=TRUE;
	   }
	...
	case 'V':
	    ...
	    if (!str_cmp( word, "VULN") && ch->version >= 12)
	    {
		 ...
		 for (vulnLooper = 1; vulnLooper <= 23; vulnLooper++)
		 {
			if ( fread_number(fp) == 1 )
			{
				if (vulnLooper == 1) SET_BIT(ch->vuln_flags,VULN_SUMMON);
				else if (vulnLooper == 2) SET_BIT(ch->vuln_flags,VULN_CHARM);
				else if (vulnLooper == 3) SET_BIT(ch->vuln_flags,VULN_MAGIC);
				else if (vulnLooper == 4) SET_BIT(ch->vuln_flags,VULN_WEAPON);
				else if (vulnLooper == 5) SET_BIT(ch->vuln_flags,VULN_BASH);
				else if (vulnLooper == 6) SET_BIT(ch->vuln_flags,VULN_PIERCE);
				else if (vulnLooper == 7) SET_BIT(ch->vuln_flags,VULN_SLASH);
				else if (vulnLooper == 8) SET_BIT(ch->vuln_flags,VULN_FIRE);
				else if (vulnLooper == 9) SET_BIT(ch->vuln_flags,VULN_COLD);
				else if (vulnLooper == 10) SET_BIT(ch->vuln_flags,VULN_LIGHTNING);
				else if (vulnLooper == 11) SET_BIT(ch->vuln_flags,VULN_ACID);
				else if (vulnLooper == 12) SET_BIT(ch->vuln_flags,VULN_POISON);
				else if (vulnLooper == 13) SET_BIT(ch->vuln_flags,VULN_NEGATIVE);
				else if (vulnLooper == 14) SET_BIT(ch->vuln_flags,VULN_HOLY);
				else if (vulnLooper == 15) SET_BIT(ch->vuln_flags,VULN_ENERGY);
				else if (vulnLooper == 16) SET_BIT(ch->vuln_flags,VULN_MENTAL);
				else if (vulnLooper == 17) SET_BIT(ch->vuln_flags,VULN_DISEASE);
				else if (vulnLooper == 18) SET_BIT(ch->vuln_flags,VULN_DROWNING);
				else if (vulnLooper == 19) SET_BIT(ch->vuln_flags,VULN_LIGHT);
				else if (vulnLooper == 20) SET_BIT(ch->vuln_flags,VULN_SOUND);
				else if (vulnLooper == 21) SET_BIT(ch->vuln_flags,VULN_WOOD);
				else if (vulnLooper == 22) SET_BIT(ch->vuln_flags,VULN_SILVER);
				else if (vulnLooper == 23) SET_BIT(ch->vuln_flags,VULN_IRON);
			}
		}
		fMatch=TRUE;
	   }

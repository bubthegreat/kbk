...
DECLARE_DO_FUN(do_shieldbash_templar);
...
DECLARE_DO_FUN( do_rising_phoenix_kick	);
DECLARE_DO_FUN( do_double_spin_kick	);
...
DECLARE_DO_FUN( do_redeeminfo		);
DECLARE_DO_FUN( do_march		);
DECLARE_DO_FUN( do_dent			);
DECLARE_DO_FUN( do_charmed		);
DECLARE_DO_FUN( do_wanted		);
DECLARE_DO_FUN( do_crescent		);
DECLARE_DO_FUN( do_cabalstat		);
DECLARE_DO_FUN( do_plant_explosive	);
DECLARE_DO_FUN( do_global_get		);

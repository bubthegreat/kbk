...
DECLARE_OLC_FUN( medit_qc		);
DECLARE_OLC_FUN( medit_tarifa		);  /* ROM */
DECLARE_OLC_FUN( medit_hitroll		);  /* ROM */
DECLARE_OLC_FUN( medit_attackmod	);
DECLARE_OLC_FUN( medit_enhancedDamMod	);
DECLARE_OLC_FUN( medit_regen_rate	);
...
DECLARE_OLC_FUN( medit_extended		);
/*
 * Macros
 */
...
HELP_DATA *new_edhelp args ( (void) );
...
void save_rooms_new args (( FILE *fp, AREA_DATA *pArea ));
void save_objects_new args (( FILE *fp, AREA_DATA *pArea ));
void save_mobiles_new args (( FILE *fp, AREA_DATA *pArea ));

void fwrite_object args( ( FILE *fp, OBJ_INDEX_DATA *pObjIndex ) );
void fwrite_mob args( ( FILE *fp, MOB_INDEX_DATA *pMobIndex ) );
void fwrite_room args( ( FILE *fp, ROOM_INDEX_DATA *pRoomIndex ) );

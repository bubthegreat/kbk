...
OBJ_INDEX_DATA *new_obj_index( void )
{
    ...
    init_bitmask(&pObj->extra_flags);
    pObj->wear_flags    =   0;
    pObj->count         =   0;
    pObj->weight        =   0;
    pObj->cost          =   0;
    pObj->material      =   find_material_by_name("none");      /* ROM */
...
MOB_INDEX_DATA *new_mob_index( void )
{
    ...
    pMob->wealth                =   0;
    pMob->quest_credit_reward	=   0;
    pMob->dam_mod		=   100;
    pMob->extended_flags	= 0;

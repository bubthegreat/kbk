...
//////////////////////////// Begin Critical Strike Check /////////////////////////////////
	if (number_percent() < ch->pcdata->learned[skill_lookup("critical strike")] / 6)
	{
		...
		{	
			...
			one_hit_new(ch,victim,dt,HIT_NOSPECIALS,HIT_UNBLOCKABLE,HIT_NOADD,175,"critical strike");
...
//////////////////////////// Begin Anaconda Stance Fight Check /////////////////////////////////
    AFFECT_DATA *anacondaCheck = affect_find(ch->affected,gsn_stance), 
                *poisonCheck = affect_find(victim->affected,gsn_poison), 
		anacondaPoison;

    int poisonLevel = 51, poisonDuration = 3, strLoss = -1;

    if (anacondaCheck != NULL)
    {
	if (anacondaCheck->level == 5)
	{
...
//////////////////////////// End Anaconda Stance Fight Check /////////////////////////////////

...
void interpret( CHAR_DATA *ch, char *argument )
{
	...
	&& strcmp(cmd_table[cmd].name,"immtalk") != 0
	&& strcmp(cmd_table[cmd].name,":") != 0)
    {
    ...
    {
        if (((found) && (strcmp(cmd_table[cmd].name,"score") != 0)
	&& (strcmp(cmd_table[cmd].name,"look") != 0)
	&& (strcmp(cmd_table[cmd].name,"who") != 0)
	&& (strcmp(cmd_table[cmd].name,"affects") != 0)
	&& (strcmp(cmd_table[cmd].name,"group") != 0)
	&& (strcmp(cmd_table[cmd].name,"gt") != 0)
	&& (strcmp(cmd_table[cmd].name,"gtell") != 0)
	&& (strcmp(cmd_table[cmd].name,":") != 0)
	&& (strcmp(cmd_table[cmd].name,"astrip") != 0)
	&& (strcmp(cmd_table[cmd].name,"immtalk") != 0) )
	|| (!found) )
        {
	...
	if (is_affected(ch,gsn_resurrect)
	&& strcmp(cmd_table[cmd].name,"immtalk") != 0
        && strcmp(cmd_table[cmd].name,"astrip") != 0)
    {
    ...
    if ((is_affected(ch,gsn_forget) && number_percent() < 75)
	&& cmd_table[cmd].position == POS_FIGHTING
	&& strcmp(cmd_table[cmd].name,"flee") != 0)
    {
	...
	&& (strcmp(cmd_table[cmd].name,"group") != 0)
	&& (strcmp(cmd_table[cmd].name,"gt") != 0)
	&& (strcmp(cmd_table[cmd].name,"reply") != 0)
	&& (strcmp(cmd_table[cmd].name,"note") != 0)
	&& (strcmp(cmd_table[cmd].name,"say") != 0)
	&& (strcmp(cmd_table[cmd].name,"gtell") != 0)
	&& (strcmp(cmd_table[cmd].name,":") != 0)
	&& (strcmp(cmd_table[cmd].name,"immtalk") != 0)
	&& (strcmp(cmd_table[cmd].name,"tell") != 0)
    && (strcmp(cmd_table[cmd].name,"cb") != 0)
	&& (strcmp(cmd_table[cmd].name,"ooctell") != 0)
	&& (strcmp(cmd_table[cmd].name,"ht") != 0)
	&& (strcmp(cmd_table[cmd].name,"n") != 0)
	&& (strcmp(cmd_table[cmd].name,"e") != 0)
	&& (strcmp(cmd_table[cmd].name,"s") != 0)
	&& (strcmp(cmd_table[cmd].name,"w") != 0)
	&& (strcmp(cmd_table[cmd].name,"north") != 0)
	&& (strcmp(cmd_table[cmd].name,"east") != 0)
	&& (strcmp(cmd_table[cmd].name,"south") != 0)
	&& (strcmp(cmd_table[cmd].name,"west") != 0)
	&& (strcmp(cmd_table[cmd].name,"up") != 0)
	&& (strcmp(cmd_table[cmd].name,"u") != 0)
	&& (strcmp(cmd_table[cmd].name,"down") != 0)
	&& (strcmp(cmd_table[cmd].name,"d") != 0)
	&& (strcmp(cmd_table[cmd].name,"where") != 0)
	&& (strcmp(cmd_table[cmd].name,"pray") != 0)
	&& (strcmp(cmd_table[cmd].name,"set") != 0)
	&& (strcmp(cmd_table[cmd].name,"open") != 0)
	&& (strcmp(cmd_table[cmd].name,"recall") != 0)
	&& (strcmp(cmd_table[cmd].name,"/") != 0)
	&& (strcmp(cmd_table[cmd].name,"quit") != 0)
	&& (strcmp(cmd_table[cmd].name,"delete") != 0))
	|| (!found) )
        {
...
void do_wizhelp( CHAR_DATA *ch, char *argument )
{
    ...
    for( clevel = LEVEL_HERO + 1; clevel < MAX_LEVEL + 1; clevel++ )
    {
        for ( cmd = 0; cmd_table[cmd].name[0] != '\0'; cmd++ )
        {
            ...
            &&   cmd_table[cmd].show
            &&   cmd_table[cmd].level == clevel && cmd_table[cmd].level <= ch->level)
            {
